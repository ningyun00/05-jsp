        ...
        <div class = "i_bg bg_color">
            <div class = "i_ban_bg">
                ...
                <div class = "inews">
                    ...
                    <ul>
                        <c:forEach items = "${requestScope.eabyNews}" var = "news" begin="0" step="1" end="5" varStatus = "i">
            ...
            <!--Begin 热门商品 Begin-->
            <div class = "content mar_10" id="row1">
                <div class = "h_l_img">
