        ...
        <div class = "menu_bg">
            <div class = "menu">
                ...
                <ul class = "menu_r">
                    ...
                    <li><a href = "#row1">美食</a></li>
                    <li><a href = "#row2">生鲜</a></li>
                    <li><a href = "#row3">家居</a></li>
                    <li><a href = "#row4">女装</a></li>
                    <li><a href = "#row5">美妆</a></li>
                    <li><a href = "#row6">数码</a></li>
                    <li><a href = "#row7">团购</a></li>
                </ul>
