                    ...
                    <table border = "0" style = "width:1000px; text-align:center;" cellspacing = "0" cellpadding = "0">
                        ...
                        <tr>
                            <td style = "font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                                ...
                                <font color = "#ff4e00"><a href = "${pageContext.request.contextPath}/PricesServlet?ordered=${sessionScope.SerialNumber}&money=${sessionScope.sumMoneyEnd}">支付宝</a></font>； &nbsp; &nbsp;您的应付款金额为: <font color = "#ff4e00">￥${sessionScope.sumMoneyEnd}</font>
                            </td>
                        </tr>
                        <tr>
