                    ...
                    <div class = "list_c">
                        ...
                        <ul class = "cate_list">
                            <c:forEach items = "${requestScope.plist}" var = "p"> <!-- ProductServlet -->
                                <li>
                                    <div class = "img">
                                        <a href = "ProductServlet?method=queryById&pid=${p.id}&pNames=${p.name}"><img src = "images/${p.fileName}" width = "210" height = "185"/></a>
                                    </div>
                                    <div class = "price">
                                    ...
                                    <div class = "carbg">
                                        <a href = "${pageContext.request.contextPath}/MemberServlet?method=memberCollect&CoId=${p.id}" class = "ss">收藏</a>
                                        <a href = "${pageContext.request.contextPath}/ProductServlet?method=addCollectCar&pid=${p.id}&count=1" onclick="return confirm('确定加入购物车吗？')" class = "j_car">加入购物车</a>
                                    </div>
                                </li>
                            </c:forEach>
                        </ul>
