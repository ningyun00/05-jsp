...
<html>
    ...
    <body>
        <jsp:include page = "NoPermissions.jsp"></jsp:include>
        <div id = "div1_bottom">
            <div id = "div2_div1">
                <table id = "table1_div2">
                    <thead id = "thead1_table1">
                        <tr><%--标题--%>
                            <th colspan = "8">
                                <h2 style = "display: inherit;text-indent: 345px">员工管理系统</h2>
                                <p style = "display: inherit;text-align: right;text-indent: 130px">
                                    欢迎小可爱：
                                <p style = "color: red;display: inherit;">
                    ...
                    <form id = "form1_tbody1" action = "/ning.ying/deleteEmpServlet" method = "post">
                        ...
                        <tbody id = "tbody4_table1">
                            <form action = "" method = "post">
                                <tr>
                                    ...
                                    <% if (oneLimit > 1) {%>
                                    <td>
                                        <button formaction = "/ning.ying/index.jsp" value = "" id = "button1_tbody4" name = "start">
                                            首页
                                        </button>
                                    </td>
                                    <td>
                                    ...
                                    <%} else {%>
                                    <td>
                                        <button formaction = "/ning.ying/index.jsp" value = "" id = "button6_tbody4" name = "start">
                                            首页
                                        </button>
                                    </td>
                                    <td>
                                        <button formaction = "/ning.ying/index.jsp" value = "" id = "button7_tbody4" name = "Last">
                                            上一页
                                        </button>
                                    </td>
                                    <%}%>
                        ...
                        <tfoot id = "tfoot1_table1">
                            <tr>
                                ...
                                <td>
                                    <form action = "/ning.ying/selectEmpServlet" method = "post">
                                        <button id = "input1_tfoot1" name = "exit" type = "submit" value = "退出" style = "width: 100px;height: 35px;text-align: center" onclick = "return confirm('确定退出吗？')">
                                            退出
                                        </button>
                                    </form>
                                </td>
                                ...
                                <form action = "/ning.ying/addEmpServlet?EID=<%=max+1%>" method = "post">
                                    <td>
                                        <p>页面访问量</p>
                                        <p style = "color:red;">
                                            <%=application.getAttribute("visitFrequency")%>
                                        </p>
                                    </td>
                                    <td>
