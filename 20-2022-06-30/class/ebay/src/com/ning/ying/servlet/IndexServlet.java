...
public class IndexServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        session.setAttribute("ProductCategoryList1", ProductCategoryList1);
        session.setAttribute("ProductCategoryList2", ProductCategoryList2);
        session.setAttribute("ProductCategoryList3", ProductCategoryList3);
        //新闻
