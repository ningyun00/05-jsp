...
public class ProductServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("twoClass".equals(method) || "threeClass".equals(method)) {
            ...
            buyCarTwo(req, resp);
        } else if ("addCollectCar".equals(method)) {
            addCollectCar(req, resp);
        }
    }
     ...
     * 直接加入购物车
     */
    private void addCollectCar(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        resp.sendRedirect("/ning.ying/ProductServlet?method=buyCarSum");
    }
    ...
    private void queryById(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        HttpSession session = req.getSession();
        session.setAttribute("bName",session.getAttribute("cname")+" > "+req.getParameter("pNames"));
