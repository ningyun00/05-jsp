        ...
        <div class = "i_bg bg_color">
            ...
            <div class = "m_content">
                ...
                <div class = "m_right">
                    ...
                    <form action = "${pageContext.request.contextPath}/MemberProductAddServlet?method=memberProductAdd" method = "post" id = "form1">
                        <textarea name = "context" id = "context" style = "display: none;"></textarea>   <!-- 添加 -->
                        <table border = "0" class = "order_tab" style = "width:930px; text-align:center; margin-bottom:30px;" cellspacing = "0" cellpadding = "0">
                            <tbody>
                                ...
                                <tr>
                                    <td width = "20%" align = "right">商品详情</td>
                                    <td width = "80%" align = "left">
                                        <div id = "editor">
                                            <p>欢迎${sessionScope.eabyUser.userName}使用。富文本编辑器</p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type = "button" value = "商品上架" class = "s_btn" onclick = "mySubmit()">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
