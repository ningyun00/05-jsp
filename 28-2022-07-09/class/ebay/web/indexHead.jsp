        ...
        <div class = "menu_bg">
            <div class = "menu">
                ...
                <ul class = "menu_r">
                    ...
                    <li><a href = "#ToAnchor1">美食</a></li>
                    <li><a href = "#ToAnchor2">生鲜</a></li>
                    <li><a href = "#ToAnchor3">家居</a></li>
                    <li><a href = "#ToAnchor4">母婴</a></li>
                    <li><a href = "#ToAnchor5">美妆</a></li>
                    <li><a href = "#ToAnchor6">数码</a></li>
                    <li><a href = "#ToAnchor7">团购</a></li>
                </ul>
