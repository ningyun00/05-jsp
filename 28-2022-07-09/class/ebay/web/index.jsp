        ...
        <div class = "i_bg bg_color">
            <div class = "i_ban_bg">
                ...
                <div class = "inews">
                    ...
                    <ul>
                        <c:forEach items = "${requestScope.eabyNews}" var = "news" begin= "" step="1" end="5" varStatus = "i">
                                        ...
                                        <c:forEach items = "${requestScope.eabyProductListHot}" var = "product" begin = "0" step = "1" end = "4">
                                            <li class = "featureBox">
                                                <div class = "box">
                                                    ...
                                                    <div class = "imgbg">
                                                        <a href = "/ning.ying/ProductServlet?method=queryById&pid=${product.id}"><img src = "images/${product.fileName}" width = "160" height = "136"/></a>
                                                    </div>
                                                    <div class = "name">
                                                        <a href = "#">
                                                            <h2>${product.name}</h2>
                ...
                <div class = "sell_right">
                    <c:forEach items = "${requestScope.eabyProductListSell}" var = "sell" begin = "0" step = "1" end = "3" varStatus = "i">
                        <div class = "sell_${i.index+1}">
                            <div class = "s_img">
                                <a href = "/ning.ying/ProductServlet?method=queryById&pid=${sell.id}"><img src = "images/${sell.fileName}" width = "185" height = "155"/></a>
                            </div>
            ...
            <!--Begin 进口 生鲜 Begin-->
            <div class = "i_t mar_10" id="ToAnchor2">
                    ...
                    <ul>
                        <c:forEach items = "${requestScope.listType660}" var = "listType660" begin = "0" step = "1" end = "5" varStatus = "i">
                            <li>
                                ...
                                <div class = "img">
                                    <a href = "/ning.ying/ProductServlet?method=queryById&pid=${listType660.id}"><img src = "images/${listType660.fileName}" width = "185" height = "155"/></a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <!--End 进口 生鲜 End-->
            <!--Begin 食品饮料 Begin-->
            <div class = "i_t mar_10" id="ToAnchor1">
                    ...
                    <ul>
                        <c:forEach items = "${requestScope.listType676}" var = "listType676" begin = "0" step = "1" end = "5" varStatus = "i">
                            <li>
                                ...
                                <div class = "img">
                                    <a href = "/ning.ying/ProductServlet?method=queryById&pid=${listType676.id}"><img src = "images/${listType676.fileName}" width = "185" height = "155"/></a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <!--End 食品饮料 End-->
            <!--Begin 个人美妆 Begin-->
            <div class = "i_t mar_10" id="ToAnchor5">
                    ...
                    <ul>
                        <c:forEach items = "${requestScope.listType548}" var = "listType548" begin = "0" step = "1" end = "5" varStatus = "i">
                            <li>
                                ...
                                <div class = "img">
                                    <a href = "/ning.ying/ProductServlet?method=queryById&pid=${listType548.id}"><img src = "images/${listType548.fileName}" width = "185" height = "155"/></a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <!--Begin 母婴玩具 Begin-->
            <div class = "i_t mar_10" id="ToAnchor4">
                    ...
                    <ul>
                        <c:forEach items = "${requestScope.listType681}" var = "listType681" begin = "0" step = "1" end = "6" varStatus = "i">
                            <li>
                                ...
                                <div class = "img">
                                    <a href = "/ning.ying/ProductServlet?method=queryById&pid=${listType681.id}"><img src = "images/${listType681.fileName}" width = "185" height = "155"/></a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <!--End 母婴玩具 End-->
            <!--Begin 家居生活 Begin-->
            <div class = "i_t mar_10" id="ToAnchor3">
            ...
            <div class = "content">
                ...
                <div class = "fresh_mid">
                    <ul>
                        <c:forEach items = "${requestScope.listType676}" var = "listType676" begin = "0" step = "1" end = "5" varStatus = "i">
                            <li>
                                <div class = "name"><a href = "#">${listType676.name}</a></div>
                                <div class = "price">
                                    <font>￥<span>${listType676.price}</span></font> &nbsp; 50R
                                </div>
                                <div class = "img">
                                    <a href = "/ning.ying/ProductServlet?method=queryById&pid=${listType676.id}"><img src = "images/${listType676.fileName}" width = "185" height = "155"/></a>
                                </div>
            ...
            <!--End 家居生活 End-->
            <!--Begin 数码家电 Begin-->
            <div class = "i_t mar_10" id="ToAnchor6">
                    ...
                    <ul>
                        <c:forEach items = "${requestScope.listType670}" var = "listType670" begin = "0" step = "1" end = "5" varStatus = "i">
                            <li>
                                ...
                                <div class = "img">
                                    <a href = "/ning.ying/ProductServlet?method=queryById&pid=${listType670.id}"><img src = "images/${listType670.fileName}" width = "185" height = "155"/></a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
                                ...
                                <ul class = "featureUL">
                                    <c:forEach items = "${requestScope.listType670}" var = "listType670" begin = "0" step = "1" end = "5" varStatus = "i">
                                        <li class = "featureBox">
                                            <div class = "box">
                                                <div class = "imgbg">
                                                    <a href = "/ning.ying/ProductServlet?method=queryById&pid=${listType670.id}"><img src = "images/${listType670.fileName}" width = "160" height = "136"/></a>
                                                </div>
                                                <div class = "name">
                                                    <a href = "#">
