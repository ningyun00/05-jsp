       ...
       <%-- <script src="https://eqcn.ajz.miesnfu.com/wp-content/plugins/wp-3d-pony/live2dw/lib/L2Dwidget.min.js"></script>
        <script >
            L2Dwidget.init({
                ...
                "react": {"opacityDefault": 0.5, "opacityOnHover": 1}
            });
        </script>--%>
                        ...
                        <table border = "0" style = "width:370px; font-size:14px; margin-top:30px;" cellspacing = "0" cellpadding = "0">
                                    ...
                                    for (int i = 0; i < cookies.length; i++) {
                                        ...
                                        if ("causer".equals(name)) {
                                           if ("".equals(c.getValue())){
                                               pageContext.setAttribute("loginName", null);
                            ...
                            <tr>
                                ...
                                <td style = "font-size:12px; padding-top:20px;">
                                    ...
                                    <span class = "fr"><a href = "${pageContext.request.contextPath}/LoginServlet?method=loginout" style = "color:#ff4e00;">清空信息记录</a></span>
                                </td>
                            </tr>
                            <tr height = "60">
                                <td>&nbsp;</td>
                                <td>
                                    <input type = "submit" value = "登录" onclick = "return login()" class = "log_btn"/>
                                </td>
                            </tr>
                        </table>
                    </form>
