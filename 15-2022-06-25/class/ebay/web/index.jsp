        ...
        <div class = "i_bg bg_color">
            <div class = "i_ban_bg">
                ...
                <div class = "inews">
                    ...
                    <ul>
                        <c:forEach items = "${requestScope.eabyNews}" var = "news" begin = "10" step = "1" end = "15" varStatus = "i">
            ...
            <div class = "content">
                ...
                <div class = "fresh_mid">
                    <ul>
                        <c:forEach items = "${requestScope.eabyProductListLevel1Id}" var = "level1Id" begin = "0" step = "1" end = "5" varStatus = "i">
                            <li>
                                <div class = "name"><a href = "#">${level1Id.name}</a></div>
                                <div class = "price">
                                    <font>￥<span>${level1Id.price}</span></font> &nbsp; 26R
                                </div>
                                <div class = "img">
                                    <a href = "#"><img src = "images/${level1Id.fileName}" width = "185" height = "155"/></a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <div class = "content">
                ...
                <div class = "fresh_mid">
                    <ul>
                        <c:forEach items = "${requestScope.ListLevel2Id}" var = "level2Id" begin = "0" step = "1" end = "5" varStatus = "i">
                            <li>
                                <div class = "name"><a href = "#">莫斯利安酸奶</a></div>
                                <div class = "price">
                                    <font>￥<span>${level2Id.price}</span></font> &nbsp; 25R
                                </div>
                                <div class = "img">
                                    <a href = "#"><img src = "images/${level2Id.fileName}" width = "185" height = "155"/></a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <div class = "content">
                ...
                <div class = "fresh_mid">
                    <ul>
                        <c:forEach items = "${requestScope.Level1Id3F}" var = "level1Id3F" begin = "0" step = "1" end = "5" varStatus = "i">
                            <li>
                                ...
                                <div class = "img">
                                    <a href = "#"><img src = "images/${level1Id3F.fileName}" width = "185" height = "155"/></a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <div class = "content">
                ...
                <div class = "fresh_mid">
                    <ul>
                        <c:forEach items = "${requestScope.Level2Id4F}" var = "level2Id4F" begin = "0" step = "1" end = "6" varStatus = "i">
                            <li>
                                ...
                                <div class = "img">
                                    <a href = "#"><img src = "images/${level2Id4F.fileName}" width = "185" height = "155"/></a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <div class = "content">
                ...
                <div class = "fresh_mid">
                    <ul>
                        <c:forEach items = "${requestScope.Level1Id6F}" var = "level1Id6F" begin = "0" step = "1" end = "5" varStatus = "i">
                            <li>
                                ...
                                <div class = "img">
                                    <a href = "#"><img src = "images/${level1Id6F.fileName}" width = "185" height = "155"/></a>
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
                    ...
                    <div id = "feature1">
                        <div id = "block1">
                            <div id = "botton-scroll1">
                                <ul class = "featureUL">
                                    <c:forEach items = "${requestScope.Level3Id}" var = "level3Id" begin = "0" step = "1" end = "5" varStatus = "i">
                                        <li class = "featureBox">
                                            <div class = "box">
                                                <div class = "imgbg">
                                                    <a href = "#"><img src = "images/${level3Id.fileName}" width = "160" height = "136"/></a>
                                                </div>
                                                <div class = "name">
                                                    <a href = "#">
                                                        <h2>德国进口</h2>
