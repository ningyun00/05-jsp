                        ...
                        <ul class = "cate_list">
                            <c:forEach items = "${requestScope.plist}" var = "p"> <!-- ProductServlet -->
                                <li>
                                    ...
                                    <div class = "carbg">
                                        <a href = "/ning.ying/MemberServlet?method=memberCollect&CoId=${p.id}" class = "ss">收藏</a>
                                        <a href = "/ning.ying/ProductServlet?method=addCollectCar&pid=${p.id}&count=1" onclick="return confirm('确定加入购物车吗？')" class = "j_car">加入购物车</a>
                                    </div>
                                </li>
                            </c:forEach>
                        </ul>
