                    ...
                    <form action = "RegistServlet?method=regist" method = "post">
                        <table border = "0" style = "width:420px; font-size:14px; margin-top:20px;" cellspacing = "0" cellpadding = "0">
                            ...
                            <tr height = "50">
                                ...
                                <td><input type = "text" name = "registUserName" value = "" class = "l_mem"/></td>
                            </tr>
                            <tr height = "50">
                                <td align = "right">邀请人ID号 &nbsp;</td>
                                <td><input type = "text" name = "registUserID" value = "" class = "l_num"/></td>
                            </tr>
                            <tr height = "50">
                                <td align = "right"><font color = "#ff4e00">*</font>&nbsp;验证码 &nbsp;</td>
                                <td>
                                    <input type="text" value="" class="l_ipt" name="yzm" id="yzm" />
                                    <%--验证码--%>
                                    <a href = "#" style = "font-size:12px; font-family:'宋体';" onclick = "changeYZM()">换一张</a>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
