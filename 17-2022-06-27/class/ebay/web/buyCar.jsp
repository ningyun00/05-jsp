                ...
                <table border = "0" class = "car_tab" style = "width:1200px; margin-bottom:50px;" cellspacing = "0" cellpadding = "0">
                   ...
                   <tbody id="tbody1">
                       <c:forEach items = "${sessionScope.shopCarList}" var = "sc" varStatus="i">  <%-- ProductServlet.java --%>
                           <tr>
                               <td>
                                   <div class = "c_s_img"><img src = "images/${sc.fileName}" width = "73" height = "73"/>
                                   </div>
                                       ${sc.name}
                               </td>
                               ...
                               <td align = "center">
                                   <div class = "c_num">
                                       ...
                                       <!--减-->
                                       <input type = "text" value = "${sc.count}" name = "" class = "car_ipt"/> <%--js脚本查看外部js文件 js/num.js --%>
                                       <input type = "button" value = "" onclick = "addUpdate1(jq(this));" class = "car_btn_2"/>
                                       <!--加-->
                                   </div>
                               </td>
                               <td align = "center" style = "color:#ff4e00;">
                                   ￥<label class = "car_sum" id="sum${i.index+1}">${sc.price * sc.count}</label></td>
