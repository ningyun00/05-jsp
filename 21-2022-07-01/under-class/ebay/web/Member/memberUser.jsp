               ...
               <%@include file="leftHead.jsp"%>
                <div class = "m_right">
                    ...
                    <table border = "0" class = "mon_tab" style = "width:870px; margin-bottom:20px;" cellspacing = "0" cellpadding = "0">
                        <tr>
                            <td width = "40%">用户ID：<span style = "color:#555555;">${sessionScope.eabyUser.id}</span></td>
                            <td width = "60%">邀请人：<span style = "color:#555555;">无</span></td>
                        </tr>
                        <tr>
                            <td>电&nbsp; &nbsp; 话：<span style = "color:#555555;">${sessionScope.eabyUser.mobile}</span></td>
                            <td>邮&nbsp; &nbsp; 箱：<span style = "color:#555555;">${sessionScope.eabyUser.email}</span></td>
                        </tr>
                        <tr>
                    ...
                    <div class = "mem_t"><a href = "memberUserAddress.jsp">地址管理</a></div>
                    <table border = "0" class = "mon_tab" style = "width:870px; margin-bottom:20px;" cellspacing = "0" cellpadding = "0">
                        <c:forEach items="${sessionScope.eabyOrder}" var="order" varStatus="i">
                           <tr>
                               <td width = "60%">编号：<span style = "color:#555555;">${i.index+1}</span></td>
