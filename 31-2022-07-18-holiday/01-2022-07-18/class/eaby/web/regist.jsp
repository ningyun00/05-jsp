...
<html xmlns = "http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type = "text/javascript" src = "js/before/regist.js"></script>
        <title>易趣商城--注册</title>
    </head>
    <body>
        <!--Begin Header Begin-->
                    ...
                    <form id="registForm">
                        <table border = "0" style = "width:420px; font-size:14px; margin-top:20px;" cellspacing = "0" cellpadding = "0">
                            ...
                            <tr height = "50">
                                ...
                                <td><input type = "password" value = "" class = "l_pwd" name = "password1"/></td>
                            </tr>
                            <tr height = "50">
                            ...
                            <tr height = "50">
                                ...
                                <td>
                                    <input type = "text" value = "" id = "yzm" class = "l_ipt"/>
                            ...
                            <tr>
                                ...
                                <td style = "font-size:12px; padding-top:20px;">
                	                <span style = "font-family:'宋体';" class = "fl">
                    	                <label class = "r_rad"><input type = "checkbox" name="checkboxYes"/></label><label class = "r_txt">我已阅读并接受《用户协议》</label>
                                    </span>
                                </td>
                            </tr>
                            <tr height = "60">
                                <td>&nbsp;</td>
                                <td>
                                    <input type = "submit" id = "register" value = "立即注册" class = "log_btn"/>
                                </td>
                            </tr>
                        </table>
                    </form>
