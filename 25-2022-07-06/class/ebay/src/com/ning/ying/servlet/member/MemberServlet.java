...
public class MemberServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("backstage".equals(method) || "memberOrder".equals(method)
            ...
            if ("memberDeleteCollect".equals(method)) {//删除我的收藏
                ...
                resp.sendRedirect("/ning.ying/memberCollectServlet?method=memberCollectServlet");
            }
     ...
     * 我的收藏
     */
    private void myCollect(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (id != null) {
            ...
            if (cookies != null) {
                for (int i = 0; i < cookies.length; i++) {
                    if ("CollectId".equals(cookies[i].getName())) {
