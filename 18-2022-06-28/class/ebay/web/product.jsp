        ...
        <div class = "top">
            ...
            <div class = "i_car">
                ...
                <div class = "car_bg">
                    ...
                    <div class = "price_a"><a href = "ProductServlet?method=buyCarSum">去购物车结算</a></div>
                    <!--End 购物车已登录 End-->
                </div>
            </div>
        </div>
            ...
            <div class = "content">
                ...
                <form action = "" method = "post" id = "formProduct">
                    <div class = "pro_des">
                        ...
                        <div class = "des_join">
                            <div class = "j_nums">
                                <input type = "text" value = "1" id = "count" name = "nameNumber" class = "n_ipt"/>
                                <input type = "button" value = "" onclick = "addUpdate(jq(this));" class = "n_btn_1"/>
                                <input type = "button" value = "" onclick = "jianUpdate(jq(this));" class = "n_btn_2"/>
                            </div>
                            <span class = "fl">
                            <%--提交--%>
                            <a onclick = "ShowDiv_One('MyDiv1','fade1', ${requestScope.product.id})"><%--onclick = "ShowDiv_1('MyDiv1','fade1')"--%>
                        ...
                        <table border = "0" align = "center" style = "margin-top:0px;" cellspacing = "0" cellpadding = "0">
                            <tr valign = "top">
                                ...
                                <td>
                                    ...
                                    购物车共有<span id = "carCount"></span>种宝贝 &nbsp; &nbsp; 合计：<span id = "carSum"></span>元
                                    <!-- ProductServlet addCar() -->
                                </td>
                            </tr>
                            <tr height = "50" valign = "bottom">
                                <td>&nbsp;</td>
                                <td><a href = "ProductServlet?method=buyCarSum" class = "b_sure">去购物车结算</a>
