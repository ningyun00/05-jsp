                    ...
                    <div class = "address">
                        ...
                        <table border = "0" class = "add_t" align = "center" style = "width:98%; margin:10px auto;" cellspacing = "0" cellpadding = "0">
                            ...
                            <c:forEach items = "${sessionScope.eabyOrder}" var = "adders" varStatus="i">
                                <tr>
                                    <td align = "right">详细地址${i.index+1}：</td>
                                    <td>${adders.address}</td>
                                    <td>
                                        <c:if test = "${adders.isDefault==0}">普通地址</c:if>
                                        <c:if test = "${adders.isDefault==1}">默认地址</c:if>
                                        <input type = "radio" checked='checked' name="adders">
                                    </td>
                                </tr>
                            </c:forEach>
                            <tr>
